...
async def create_project(
    ...
    project = await service.create_project(db, data.tenant_id, data)
...
async def list_projects(
    ...
    tenant_ids = get_user_tenant_ids(current_user)
    projects, total = await service.list_projects(db, tenant_ids, page, per_page, status)
...
async def get_project(
    ...
    tenant_ids = get_user_tenant_ids(current_user)
    project = await service.get_project(db, tenant_ids, project_id)
...
async def update_project(
    ...
    tenant_ids = get_user_tenant_ids(current_user)
    project = await service.update_project(db, tenant_ids, project_id, data)
